...
const CATALOGUE = [
  { id: 1, name: "Castle Lager 6-pack", brand: "Castle", category: "Beer", size: "6×340ml", emoji: "🍺", popular: true, price: 89 },
  { id: 2, name: "Castle Lite 6-pack", brand: "Castle", category: "Beer", size: "6×340ml", emoji: "🍺", popular: true, price: 92 },
  { id: 3, name: "Black Label 6-pack", brand: "Black Label", category: "Beer", size: "6×340ml", emoji: "🍺", popular: true, price: 89 },
  { id: 4, name: "Carling Black Label 750ml", brand: "Carling", category: "Beer", size: "750ml", emoji: "🍺", popular: true, price: 22 },
  { id: 5, name: "Heineken 6-pack", brand: "Heineken", category: "Beer", size: "6×330ml", emoji: "🍺", popular: true, price: 110 },
  { id: 6, name: "Hansa Pilsener 6-pack", brand: "Hansa", category: "Beer", size: "6×340ml", emoji: "🍺", popular: false, price: 85 },
  { id: 7, name: "Amstel Lager 6-pack", brand: "Amstel", category: "Beer", size: "6×340ml", emoji: "🍺", popular: false, price: 88 },
  { id: 8, name: "Corona Extra 6-pack", brand: "Corona", category: "Beer", size: "6×355ml", emoji: "🍺", popular: false, price: 120 },
  { id: 9, name: "Windhoek Lager 6-pack", brand: "Windhoek", category: "Beer", size: "6×340ml", emoji: "🍺", popular: false, price: 95 },
  { id: 11, name: "Savanna Dry 6-pack", brand: "Savanna", category: "Cider", size: "6×330ml", emoji: "🍋", popular: true, price: 105 },
  { id: 12, name: "Savanna Premium 6-pack", brand: "Savanna", category: "Cider", size: "6×330ml", emoji: "🍋", popular: false, price: 110 },
  { id: 13, name: "Hunters Gold 6-pack", brand: "Hunters", category: "Cider", size: "6×330ml", emoji: "🍋", popular: true, price: 95 },
  { id: 14, name: "Hunters Dry 6-pack", brand: "Hunters", category: "Cider", size: "6×330ml", emoji: "🍋", popular: false, price: 95 },
  { id: 15, name: "Brutal Fruit Ruby 6-pack", brand: "Brutal Fruit", category: "Cider", size: "6×330ml", emoji: "🍓", popular: true, price: 98 },
  { id: 16, name: "Flying Fish Lemon 6-pack", brand: "Flying Fish", category: "Cider", size: "6×330ml", emoji: "🐟", popular: false, price: 100 },
  { id: 17, name: "Bernini Blush 6-pack", brand: "Bernini", category: "Cider", size: "6×275ml", emoji: "🍾", popular: false, price: 90 },
  { id: 18, name: "Johnnie Walker Red 750ml", brand: "Johnnie Walker", category: "Whisky", size: "750ml", emoji: "🥃", popular: true, price: 289 },
  { id: 19, name: "Johnnie Walker Black 750ml", brand: "Johnnie Walker", category: "Whisky", size: "750ml", emoji: "🥃", popular: true, price: 389 },
  { id: 20, name: "Jack Daniel's 750ml", brand: "Jack Daniel's", category: "Whisky", size: "750ml", emoji: "🥃", popular: true, price: 319 },
  { id: 21, name: "Jameson Irish 750ml", brand: "Jameson", category: "Whisky", size: "750ml", emoji: "🥃", popular: true, price: 299 },
  { id: 22, name: "Klipdrift Premium 750ml", brand: "Klipdrift", category: "Whisky", size: "750ml", emoji: "🥃", popular: true, price: 189 },
  { id: 23, name: "Glenfiddich 12yr 750ml", brand: "Glenfiddich", category: "Whisky", size: "750ml", emoji: "🥃", popular: false, price: 699 },
  { id: 24, name: "Chivas Regal 12yr 750ml", brand: "Chivas", category: "Whisky", size: "750ml", emoji: "🥃", popular: false, price: 549 },
  { id: 25, name: "Smirnoff 1L", brand: "Smirnoff", category: "Vodka", size: "1L", emoji: "🍸", popular: true, price: 199 },
  { id: 26, name: "Absolut Original 750ml", brand: "Absolut", category: "Vodka", size: "750ml", emoji: "🍸", popular: true, price: 249 },
  { id: 27, name: "Cruz Watermelon 750ml", brand: "Cruz", category: "Vodka", size: "750ml", emoji: "🍉", popular: true, price: 189 },
  { id: 28, name: "Skyy Vodka 750ml", brand: "Skyy", category: "Vodka", size: "750ml", emoji: "🍸", popular: false, price: 229 },
  { id: 29, name: "Cîroc 750ml", brand: "Cîroc", category: "Vodka", size: "750ml", emoji: "🍸", popular: false, price: 499 },
  { id: 30, name: "Captain Morgan 750ml", brand: "Captain Morgan", category: "Rum & Gin", size: "750ml", emoji: "🏴‍☠️", popular: true, price: 229 },
  { id: 31, name: "Bacardi White 750ml", brand: "Bacardi", category: "Rum & Gin", size: "750ml", emoji: "🏴‍☠️", popular: false, price: 219 },
  { id: 32, name: "Bombay Sapphire 750ml", brand: "Bombay", category: "Rum & Gin", size: "750ml", emoji: "🫙", popular: false, price: 349 },
  { id: 33, name: "Hendrick's Gin 750ml", brand: "Hendrick's", category: "Rum & Gin", size: "750ml", emoji: "🫙", popular: false, price: 499 },
  { id: 34, name: "Inverroche Gin 750ml", brand: "Inverroche", category: "Rum & Gin", size: "750ml", emoji: "🫙", popular: false, price: 399 },
  { id: 35, name: "Four Cousins Sweet Red 750ml", brand: "Four Cousins", category: "Wine", size: "750ml", emoji: "🍷", popular: true, price: 75 },
  { id: 36, name: "Drostdy-Hof Cabernet 750ml", brand: "Drostdy-Hof", category: "Wine", size: "750ml", emoji: "🍷", popular: true, price: 79 },
  { id: 37, name: "Nederburg Rosé 750ml", brand: "Nederburg", category: "Wine", size: "750ml", emoji: "🍷", popular: false, price: 99 },
  { id: 38, name: "Two Oceans Sauvignon 750ml", brand: "Two Oceans", category: "Wine", size: "750ml", emoji: "🍷", popular: false, price: 89 },
  { id: 39, name: "Robertson Merlot 750ml", brand: "Robertson", category: "Wine", size: "750ml", emoji: "🍷", popular: false, price: 85 },
  { id: 40, name: "J.C. Le Roux La Vallée 750ml", brand: "J.C. Le Roux", category: "Bubbly", size: "750ml", emoji: "🥂", popular: true, price: 99 },
  { id: 41, name: "J.C. Le Roux Rosé 750ml", brand: "J.C. Le Roux", category: "Bubbly", size: "750ml", emoji: "🥂", popular: true, price: 105 },
  { id: 42, name: "Pongrácz Brut 750ml", brand: "Pongrácz", category: "Bubbly", size: "750ml", emoji: "🥂", popular: false, price: 179 },
  { id: 43, name: "Graham Beck Brut 750ml", brand: "Graham Beck", category: "Bubbly", size: "750ml", emoji: "🥂", popular: false, price: 199 },
  { id: 44, name: "Moët & Chandon 750ml", brand: "Moët", category: "Bubbly", size: "750ml", emoji: "🥂", popular: false, price: 899 },
  { id: 45, name: "Amarula 750ml", brand: "Amarula", category: "Liqueur", size: "750ml", emoji: "🐘", popular: true, price: 199 },
  { id: 46, name: "Olmeca Tequila 750ml", brand: "Olmeca", category: "Liqueur", size: "750ml", emoji: "🌵", popular: true, price: 249 },
  { id: 47, name: "Jose Cuervo Gold 750ml", brand: "Jose Cuervo", category: "Liqueur", size: "750ml", emoji: "🌵", popular: false, price: 279 },
  { id: 48, name: "Jägermeister 750ml", brand: "Jägermeister", category: "Liqueur", size: "750ml", emoji: "🦌", popular: false, price: 289 },
];

const ZONES = [
  { name: "Zone 1", areas: "CBD, Sonheuwel, Berghof", km: "0–5km", fee: 50, driverEarns: 35 },
  { name: "Zone 2", areas: "West Acres, Kamagugu, Valencia, Mataffin", km: "6–12km", fee: 65, driverEarns: 50 },
];

const CATS = ["🔥 Popular", "All", "Beer", "Cider", "Whisky", "Vodka", "Rum & Gin", "Wine", "Bubbly", "Liqueur"];
...
export default function App() {
  ...
  const filtered = CATALOGUE.filter(p => {
    const matchCat = filter === "All" ? true : filter === "🔥 Popular" ? p.popular : p.category === filter;
  ...
  if (screen === "home") return (
    <div style={app}>
      ...
      <div style={{ padding: "18px 20px 0", position: "sticky", top: 0, zIndex: 10, background: "linear-gradient(180deg,#080810 80%,transparent)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ fontSize: 11, color: "#4ade80", fontWeight: 600 }}>Open · 2AM</div>
          </div>
        </div>
      ...
      <div style={{ margin: "4px 20px 14px", background: "linear-gradient(135deg,#160e02,#241206)", border: "1px solid rgba(232,160,32,0.18)", borderRadius: 22, padding: "18px 20px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 20, fontWeight: 900, lineHeight: 1.3, marginBottom: 6, color: "#fff" }}>Your late night spot,<br />delivered. 🌙</div>
        <div style={{ fontSize: 12, color: "#E8A020", fontWeight: 600 }}>Nelspruit · ~30 mins · 🔒 Photo-verified</div>
      </div>
      ...
      <div style={{ padding: "0 20px 10px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: "rgba(255,255,255,0.7)" }}>
          {search ? `Results for "${search}"` : filter === "🔥 Popular" ? "🔥 Most Popular" : filter === "All" ? "All Products" : filter}
          <span style={{ fontSize: 11, color: "#333", fontWeight: 400, marginLeft: 6 }}>{filtered.length} items</span>
        </div>
        <div style={{ fontSize: 10, color: "#2a2a3a" }}>🏪 Lucky Star · CBD</div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, padding: "0 20px" }}>
        {filtered.map(p => (
          <div key={p.id} style={{ background: "#0e0e1a", border: `1px solid ${cart[p.id] ? "rgba(232,160,32,0.35)" : "#1a1a2a"}`, borderRadius: 18, padding: 14, position: "relative", transition: "border 0.2s" }}>
            {p.popular && !search && <div style={{ position: "absolute", top: 9, right: 9, background: "rgba(232,160,32,0.12)", border: "1px solid rgba(232,160,32,0.25)", borderRadius: 7, padding: "2px 5px", fontSize: 9, color: "#E8A020", fontWeight: 700 }}>🔥</div>}
            ...
            {cart[p.id] ? (
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 10, background: "#16162a", borderRadius: 10, padding: "4px 10px" }}>
                <button onClick={() => rem(p.id)} style={{ background: "none", border: "none", color: "#E8A020", fontSize: 22, fontWeight: 700, cursor: "pointer" }}>−</button>
    ...
    <div style={app}>
      ...
      <div style={scr}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <button onClick={() => setScreen("home")} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.5)", fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: "'Ubuntu',sans-serif" }}>← Back</button>
          <Wordmark size="sm" />
        </div>
        <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 24, fontWeight: 900, marginBottom: 20 }}>Your Order 🛒</div>
          ...
          return (
            <div key={id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: "1px solid #141424" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: "#444", marginTop: 1 }}>{p.size} × {qty}</div>
              </div>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 5 }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#E8A020" }}>R{p.price * qty}</div>
                <div style={{ display: "flex", gap: 6 }}>
                  <button onClick={() => rem(p.id)} style={{ background: "#16162a", border: "none", color: "#E8A020", width: 26, height: 26, borderRadius: 8, fontSize: 16, fontWeight: 700, cursor: "pointer" }}>−</button>
        ...
        <div style={{ marginTop: 20 }}>
          <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 12 }}>📍 Delivery Zone</div>
          {ZONES.map(z => (
        ...
        <div style={{ marginTop: 4 }}>
          <div style={{ fontSize: 14, fontWeight: 700, marginBottom: 2 }}>📍 Address</div>
          <input style={inp} placeholder="Enter your delivery address..." value={address} onChange={e => setAddress(e.target.value)} />
        </div>
        <div style={{ marginTop: 16 }}>
          <div style={{ fontSize: 14, fontWeight: 700, marginBottom: 4 }}>💳 Payment</div>
          {[{ id: "snapscan", label: "SnapScan", icon: "📱" }, { id: "payfast", label: "PayFast (Card)", icon: "💳" }].map(m => (
            <div key={m.id} onClick={() => setPay(m.id)} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", background: pay === m.id ? "#0a160a" : "#0e0e1a", border: `1px solid ${pay === m.id ? "#4ade80" : "#1a1a2a"}`, borderRadius: 12, cursor: "pointer", marginTop: 8 }}>
              ...
              {pay === m.id && <span style={{ marginLeft: "auto", color: "#4ade80" }}>✓</span>}
            </div>
          ))}
        </div>
        <div style={{ ...alertBox("#60a5fa"), marginTop: 16 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#60a5fa", marginBottom: 3 }}>🔒 Photo-Verified Delivery</div>
          <div style={{ fontSize: 11, color: "#444" }}>Photos auto-deleted when you confirm receipt.</div>
        </div>
        <button style={btn()} onClick={() => { setScreen("tracking"); setStage(1); }}>Place Order 🚀</button>
      </div>
    </div>
  );
    ...
    <div style={app}>
      ...
      <div style={scr}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
          {[["customer", "👤 Customer"], ["driver", "🛵 Driver"]].map(([t, l]) => (
        ...
        {tab === "customer" && (
          <>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              <div style={{ fontSize: 60, animation: stage >= 2 ? "bounce 2s infinite" : "none", marginBottom: 12 }}>{stage === 4 ? "🎉" : stage >= 2 ? "🛵" : "📦"}</div>
              <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 22, fontWeight: 900 }}>{stage === 4 ? "Delivered! 🍺" : stage === 3 ? "Driver at your door!" : stage === 2 ? "On the way! 🛵" : "Order Confirmed!"}</div>
              <div style={{ fontSize: 13, color: "#444", marginTop: 6 }}>Est. ~25 mins · Lucky Star CBD</div>
            </div>
            {[{label:"Order received & paid",icon:"✅",s:1},{label:"Store packed — photo taken 📸",icon:"📦",s:1},{label:"Driver collected — photo taken 📸",icon:"🛵",s:2},{label:"Driver at your door — photo taken 📸",icon:"📍",s:3},{label:"Confirmed by you ✅",icon:"🎉",s:4}].map((step, i) => (
            ...
            {stage >= 2 && stage < 4 && (
              <div style={{ ...alertBox("#E8A020"), marginTop: 8 }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#E8A020", marginBottom: 8 }}>📸 Photos on Record</div>
                <div style={{ display: "flex", gap: 8 }}>
                  {[{ l: "Pickup", d: pickup }, { l: "Delivery", d: delivery }].map(ph => (
                    <div key={ph.l} style={{ flex: 1, background: ph.d ? "#0a140a" : "#0e0e1a", border: `1px solid ${ph.d ? "#4ade8033" : "#1a1a2a"}`, borderRadius: 10, padding: 10, textAlign: "center", fontSize: 12, color: ph.d ? "#4ade80" : "#333" }}>{ph.d ? "✅ " : "⏳ "}{ph.l} photo</div>
                  ))}
                </div>
            ...
            {stage === 3 && !problem && (
              <>
                <button style={btn("#22c55e")} onClick={() => { setPickup(false); setDelivery(false); setStage(4); }}>✅ Received & All Good — Delete Photos</button>
                <button onClick={() => setProblem(true)} style={{ width: "100%", padding: 14, background: "transparent", border: "1px solid #ef4444", borderRadius: 14, color: "#ef4444", fontSize: 14, fontWeight: 700, cursor: "pointer", marginTop: 8, fontFamily: "'Ubuntu',sans-serif" }}>⚠️ Report a Problem</button>
              </>
            )}
            {problem && <div style={{ ...alertBox("#ef4444"), marginTop: 12 }}><div style={{ fontSize: 13, color: "#ef4444", fontWeight: 700 }}>⚠️ Photos kept. Management contacts you within 30 mins.</div></div>}
            {stage === 4 && (
              <>
                <div style={{ ...alertBox("#22c55e"), textAlign: "center", marginTop: 12 }}><div style={{ fontSize: 14, fontWeight: 700, color: "#22c55e" }}>🗑️ Photos Deleted · Enjoy! 🍺</div></div>
                <button style={btn()} onClick={() => { setScreen("home"); setCart({}); setStage(0); setPickup(false); setDelivery(false); setProblem(false); setZone(null); }}>Order Again 🍺</button>
              </>
            )}
            {stage < 3 && (
              <div style={{ marginTop: 16, padding: 14, background: "#080810", border: "1px solid #111120", borderRadius: 14 }}>
                ...
                {stage === 1 && <button style={{ ...btn("#6366f1"), marginTop: 0 }} onClick={() => { setPickup(true); setStage(2); }}>Simulate: Driver Collected 📸</button>}
                {stage === 2 && <button style={{ ...btn("#8b5cf6"), marginTop: 0 }} onClick={() => { setDelivery(true); setStage(3); }}>Simulate: Driver Arrived 📸</button>}
              </div>
            )}
          </>
        )}
        {tab === "driver" && (
          <>
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 20, fontWeight: 900, marginBottom: 4 }}>Driver Dashboard 🛵</div>
            ...
            <div style={{ background: "#0e0e1a", border: "1px solid rgba(232,160,32,0.15)", borderRadius: 16, padding: 16, marginBottom: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#E8A020", marginBottom: 10 }}>📦 Active Order #UM2847</div>
              {[["🏪 Pickup","Lucky Star Chinese Shop, CBD"],["📍 Deliver to","14 Sonheuwel Ave, Nelspruit"],["🗺️ Zone","Zone 1 · ~3.2km · Earn R35"]].map(([l,v]) => (
                <div key={l} style={{ fontSize: 13, color: "#555", marginBottom: 6 }}><span style={{ color: "#777" }}>{l}:</span> {v}</div>
              ))}
              <div style={{ fontSize: 13, fontWeight: 700, margin: "14px 0 10px" }}>📸 Required Photos</div>
              {[{label:"Pickup Photo",sub:"Photo of packed order at store",done:pickup,action:()=>{setPickup(true);setStage(2);},canTap:!pickup},{label:"Delivery Photo",sub:pickup?"Photo at customer door":"Complete pickup first",done:delivery,action:()=>{setDelivery(true);setStage(3);},canTap:pickup&&!delivery}].map((ph,i)=>(
                <div key={i} onClick={ph.canTap?ph.action:undefined} style={{ background: ph.done?"#0a140a":"#080810", border:`2px dashed ${ph.done?"#4ade8066":"#1a1a2a"}`, borderRadius:14, padding:18, textAlign:"center", marginBottom:12, cursor:ph.canTap?"pointer":"default" }}>
                  {ph.done?<><div style={{fontSize:28,marginBottom:4}}>✅</div><div style={{fontSize:13,color:"#4ade80",fontWeight:700}}>{ph.label} Captured</div></>:<><div style={{fontSize:28,marginBottom:4}}>📷</div><div style={{fontSize:13,color:ph.canTap?"#666":"#2a2a3a",fontWeight:600}}>Tap — {ph.label}</div><div style={{fontSize:11,color:"#2a2a3a"}}>{ph.sub}</div></>}
                </div>
              ))}
              {stage===4&&<div style={{...alertBox("#22c55e")}}><div style={{fontSize:13,color:"#22c55e",fontWeight:700}}>✅ Confirmed! R35 added to your earnings.</div></div>}
            </div>
            <div style={{ background: "#0e0e1a", border: "1px solid #141424", borderRadius: 16, padding: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#444", marginBottom: 12 }}>💰 Tonight's Earnings</div>
