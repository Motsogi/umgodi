...
const CATALOGUE = [
  { id: 1, name: "Castle Lager 6-pack", brand: "Castle", category: "Beer", size: "6?340ml", emoji: "\u{1F37A}", popular: true, price: 89 },
  { id: 2, name: "Castle Lite 6-pack", brand: "Castle", category: "Beer", size: "6?340ml", emoji: "\u{1F37A}", popular: true, price: 92 },
  { id: 3, name: "Black Label 6-pack", brand: "Black Label", category: "Beer", size: "6?340ml", emoji: "\u{1F37A}", popular: true, price: 89 },
  { id: 4, name: "Carling Black Label 750ml", brand: "Carling", category: "Beer", size: "750ml", emoji: "\u{1F37A}", popular: true, price: 22 },
  { id: 5, name: "Heineken 6-pack", brand: "Heineken", category: "Beer", size: "6?330ml", emoji: "\u{1F37A}", popular: true, price: 110 },
  { id: 6, name: "Hansa Pilsener 6-pack", brand: "Hansa", category: "Beer", size: "6?340ml", emoji: "\u{1F37A}", popular: false, price: 85 },
  { id: 7, name: "Amstel Lager 6-pack", brand: "Amstel", category: "Beer", size: "6?340ml", emoji: "\u{1F37A}", popular: false, price: 88 },
  { id: 8, name: "Corona Extra 6-pack", brand: "Corona", category: "Beer", size: "6?355ml", emoji: "\u{1F37A}", popular: false, price: 120 },
  { id: 9, name: "Windhoek Lager 6-pack", brand: "Windhoek", category: "Beer", size: "6?340ml", emoji: "\u{1F37A}", popular: false, price: 95 },
  { id: 11, name: "Savanna Dry 6-pack", brand: "Savanna", category: "Cider", size: "6?330ml", emoji: "\u{1F34B}", popular: true, price: 105 },
  { id: 12, name: "Savanna Premium 6-pack", brand: "Savanna", category: "Cider", size: "6?330ml", emoji: "\u{1F34B}", popular: false, price: 110 },
  { id: 13, name: "Hunters Gold 6-pack", brand: "Hunters", category: "Cider", size: "6?330ml", emoji: "\u{1F34B}", popular: true, price: 95 },
  { id: 14, name: "Hunters Dry 6-pack", brand: "Hunters", category: "Cider", size: "6?330ml", emoji: "\u{1F34B}", popular: false, price: 95 },
  { id: 15, name: "Brutal Fruit Ruby 6-pack", brand: "Brutal Fruit", category: "Cider", size: "6?330ml", emoji: "\u{1F353}", popular: true, price: 98 },
  { id: 16, name: "Flying Fish Lemon 6-pack", brand: "Flying Fish", category: "Cider", size: "6?330ml", emoji: "\u{1F41F}", popular: false, price: 100 },
  { id: 18, name: "Johnnie Walker Red 750ml", brand: "Johnnie Walker", category: "Whisky", size: "750ml", emoji: "\u{1F943}", popular: true, price: 289 },
  { id: 19, name: "Johnnie Walker Black 750ml", brand: "Johnnie Walker", category: "Whisky", size: "750ml", emoji: "\u{1F943}", popular: true, price: 389 },
  { id: 20, name: "Jack Daniel's 750ml", brand: "Jack Daniel's", category: "Whisky", size: "750ml", emoji: "\u{1F943}", popular: true, price: 319 },
  { id: 21, name: "Jameson Irish 750ml", brand: "Jameson", category: "Whisky", size: "750ml", emoji: "\u{1F943}", popular: true, price: 299 },
  { id: 22, name: "Klipdrift Premium 750ml", brand: "Klipdrift", category: "Whisky", size: "750ml", emoji: "\u{1F943}", popular: true, price: 189 },
  { id: 25, name: "Smirnoff 1818 750ml", brand: "Smirnoff", category: "Vodka", size: "750ml", emoji: "\u{1F378}", popular: true, price: 199 },
  { id: 26, name: "Absolut Original 750ml", brand: "Absolut", category: "Vodka", size: "750ml", emoji: "\u{1F378}", popular: true, price: 249 },
  { id: 27, name: "Cruz Watermelon 750ml", brand: "Cruz", category: "Vodka", size: "750ml", emoji: "\u{1F349}", popular: true, price: 189 },
  { id: 28, name: "C?roc 750ml", brand: "C?roc", category: "Vodka", size: "750ml", emoji: "\u{1F378}", popular: false, price: 499 },
  { id: 30, name: "Hennessy VS 750ml", brand: "Hennessy", category: "Cognac", size: "750ml", emoji: "\u{1F943}", popular: true, price: 599 },
  { id: 31, name: "Hennessy VSOP 750ml", brand: "Hennessy", category: "Cognac", size: "750ml", emoji: "\u{1F943}", popular: true, price: 899 },
  { id: 32, name: "R?my Martin VS 750ml", brand: "R?my Martin", category: "Cognac", size: "750ml", emoji: "\u{1F943}", popular: false, price: 549 },
  { id: 33, name: "Captain Morgan 750ml", brand: "Captain Morgan", category: "Rum", size: "750ml", emoji: "\u{1F3F4}?\u{2620}\u{FE0F}", popular: true, price: 229 },
  { id: 34, name: "Bacardi White 750ml", brand: "Bacardi", category: "Rum", size: "750ml", emoji: "\u{1F3F4}?\u{2620}\u{FE0F}", popular: false, price: 219 },
  { id: 35, name: "Bombay Sapphire 750ml", brand: "Bombay", category: "Gin", size: "750ml", emoji: "\u{1FAD9}", popular: true, price: 349 },
  { id: 36, name: "Gordon's Pink Gin 750ml", brand: "Gordon's", category: "Gin", size: "750ml", emoji: "\u{1F338}", popular: true, price: 249 },
  { id: 37, name: "Hendrick's Gin 750ml", brand: "Hendrick's", category: "Gin", size: "750ml", emoji: "\u{1F952}", popular: false, price: 499 },
  { id: 38, name: "Four Cousins Sweet Red 750ml", brand: "Four Cousins", category: "Wine", size: "750ml", emoji: "\u{1F377}", popular: true, price: 75 },
  { id: 39, name: "Drostdy-Hof Adelpragt 750ml", brand: "Drostdy-Hof", category: "Wine", size: "750ml", emoji: "\u{1F377}", popular: true, price: 79 },
  { id: 40, name: "J.C. Le Roux La Vall?e 750ml", brand: "J.C. Le Roux", category: "Bubbly", size: "750ml", emoji: "\u{1F942}", popular: true, price: 99 },
  { id: 41, name: "Pongr?cz Brut 750ml", brand: "Pongr?cz", category: "Bubbly", size: "750ml", emoji: "\u{1F942}", popular: false, price: 179 },
  { id: 42, name: "J?germeister 750ml", brand: "J?germeister", category: "Yegas", size: "750ml", emoji: "\u{1F98C}", popular: true, price: 289 },
  { id: 43, name: "Olmeca Tequila Gold 750ml", brand: "Olmeca", category: "Yegas", size: "750ml", emoji: "\u{1F335}", popular: true, price: 249 },
  { id: 44, name: "Amarula 750ml", brand: "Amarula", category: "Yegas", size: "750ml", emoji: "\u{1F418}", popular: true, price: 199 },
  { id: 45, name: "Coca Cola 2L", brand: "Coca Cola", category: "Mixers", size: "2L", emoji: "\u{1F964}", popular: true, price: 28 },
  { id: 46, name: "Schweppes Tonic 6-pack", brand: "Schweppes", category: "Mixers", size: "6-pack", emoji: "\u{1F964}", popular: true, price: 65 },
  { id: 47, name: "Fever-Tree Indian Tonic 750ml", brand: "Fever-Tree", category: "Mixers", size: "750ml", emoji: "\u{1F33F}", popular: false, price: 89 },
  { id: 48, name: "Ice Bag 2kg", brand: "Ice", category: "Extras", size: "2kg", emoji: "\u{1F9CA}", popular: true, price: 25 },
  { id: 49, name: "Simba Chips 145g", brand: "Simba", category: "Extras", size: "145g", emoji: "\u{1F35F}", popular: true, price: 22 },
  { id: 50, name: "Doritos Nacho Cheese 145g", brand: "Doritos", category: "Extras", size: "145g", emoji: "\u{1F33D}", popular: true, price: 25 },
  { id: 51, name: "Grandpa Headache Powders", brand: "Grandpa", category: "Extras", size: "12-pack", emoji: "\u{1F48A}", popular: false, price: 35 },
  { id: 52, name: "Durex Originals 3-pack", brand: "Durex", category: "Extras", size: "3-pack", emoji: "\u{1F6E1}\u{FE0F}", popular: false, price: 89 },
];

const ZONES = [
  { name: "Zone 1", areas: "CBD, Sonheuwel, Berghof", km: "0?5km", fee: 50 },
  { name: "Zone 2", areas: "West Acres, Kamagugu, Valencia, Mataffin", km: "6?12km", fee: 65 },
];

const CATS = ["\u{1F525} Popular", "All", "Beer", "Cider", "Whisky", "Cognac", "Vodka", "Rum", "Gin", "Wine", "Bubbly", "Yegas", "Mixers", "Extras"];
...
export default function App() {
  ...
  const [filter, setFilter] = useState("\u{1F525} Popular");
  ...
  const filtered = CATALOGUE.filter(p => {
    const matchCat = filter === "All" ? true : filter === "\u{1F525} Popular" ? p.popular : p.category === filter;
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: isMobile ? "0 16px" : "0 40px", display: "flex", alignItems: "center", justifyContent: "space-between", height: isMobile ? 60 : 72 }}>
        ...
        {!isMobile && screen === "home" && (
          <div style={{ flex: 1, maxWidth: 420, margin: "0 40px", position: "relative" }}>
            <div style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 14, opacity: 0.4 }}>\u{1F50D}</div>
            <input
        ...
        <div style={{ display: "flex", alignItems: "center", gap: isMobile ? 10 : 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ fontSize: isMobile ? 11 : 13, color: "#4ade80", fontWeight: 600 }}>Open ? 12PM?2AM</div>
          </div>
          {count > 0 && (
            <button onClick={() => setScreen("cart")} style={{ background: "linear-gradient(135deg,#E8A020,#C8601A)", border: "none", borderRadius: 12, padding: isMobile ? "8px 14px" : "10px 20px", color: "#fff", fontWeight: 700, fontSize: isMobile ? 13 : 14, cursor: "pointer", display: "flex", alignItems: "center", gap: 8, fontFamily: "'DM Sans',sans-serif", boxShadow: "0 4px 16px rgba(232,160,32,0.3)" }}>
              \u{1F6D2} {isMobile ? count : `${count} items ? R${subtotal}`}
            </button>
          )}
        </div>
      </div>
    ...
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: "#faf8f5", minHeight: "100vh" }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#0e0a04 0%,#1a0f02 50%,#241206 100%)", padding: isMobile ? "32px 20px" : "60px 40px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: isMobile ? 11 : 12, letterSpacing: "3px", textTransform: "uppercase", color: "#E8A020", fontWeight: 700, marginBottom: 12 }}>\u{1F319} Nelspruit's #1 After Hours Delivery</div>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              {["\u{1F37A} Beer & Cider", "\u{1F943} Spirits", "\u{1F377} Wine", "\u{1F9CA} Ice & Snacks"].map(t => (
      ...
      {isMobile && (
        <div style={{ padding: "12px 16px", background: "#fff", borderBottom: "1px solid #f0ede8" }}>
          <div style={{ position: "relative" }}>
            <div style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", fontSize: 14, opacity: 0.4 }}>\u{1F50D}</div>
        ...
        {!isMobile && (
          <div style={{ width: 220, flexShrink: 0, position: "sticky", top: 88, paddingTop: 32, paddingBottom: 32 }}>
            ...
            <div style={{ marginTop: 24, background: "#fff", borderRadius: 16, padding: 16, border: "1px solid #f0ede8" }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: "#333", marginBottom: 10 }}>\u{1F697} Delivery Zones</div>
              {ZONES.map(z => (
                <div key={z.name} style={{ marginBottom: 8 }}>
                  <div style={{ fontSize: 13, fontWeight: 600, color: "#C8601A" }}>{z.name} ? R{z.fee}</div>
                  <div style={{ fontSize: 11, color: "#888" }}>{z.areas}</div>
                </div>
              ))}
              <div style={{ fontSize: 11, color: "#bbb", marginTop: 8, borderTop: "1px solid #f0ede8", paddingTop: 8 }}>\u{1F512} Photo-verified delivery</div>
            </div>
          </div>
        )}
          ...
          <div style={{ padding: isMobile ? "16px 16px 8px" : "0 0 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <div style={{ fontSize: isMobile ? 16 : 20, fontWeight: 800, color: "#1a0f02", fontFamily: "'Playfair Display',serif" }}>
                {search ? `Results for "${search}"` : filter === "\u{1F525} Popular" ? "\u{1F525} Most Popular" : filter === "All" ? "All Products" : filter}
              </div>
              <div style={{ fontSize: 12, color: "#aaa", marginTop: 2 }}>{filtered.length} products available</div>
            </div>
            <div style={{ fontSize: 11, color: "#ccc", display: "flex", alignItems: "center", gap: 4 }}>\u{1F3EA} Lucky Star ? CBD</div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(auto-fill, minmax(200px, 1fr))", gap: isMobile ? 10 : 16, padding: isMobile ? "0 16px" : "0" }}>
            {filtered.map(p => (
              <div key={p.id} className="product-card" style={{ background: "#fff", border: `1.5px solid ${cart[p.id] ? "#E8A020" : "#f0ede8"}`, borderRadius: isMobile ? 16 : 20, padding: isMobile ? 14 : 18, position: "relative", boxShadow: "0 2px 12px rgba(0,0,0,0.04)", cursor: "default" }}>
                {p.popular && (
                  <div style={{ position: "absolute", top: 10, right: 10, background: "linear-gradient(135deg,#E8A020,#C8601A)", borderRadius: 6, padding: "2px 7px", fontSize: 9, color: "#fff", fontWeight: 700 }}>\u{1F525} HOT</div>
                )}
                ...
                {cart[p.id] ? (
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#fdf6ee", borderRadius: 10, padding: "4px 10px", border: "1px solid rgba(232,160,32,0.2)" }}>
                    <button onClick={() => rem(p.id)} style={{ background: "none", border: "none", color: "#E8A020", fontSize: 22, fontWeight: 700, cursor: "pointer", lineHeight: 1 }}>?</button>
      ...
      {count > 0 && isMobile && (
        <div onClick={() => setScreen("cart")} style={{ position: "fixed", bottom: 20, left: 20, right: 20, background: "linear-gradient(135deg,#E8A020,#C8601A)", borderRadius: 16, padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer", boxShadow: "0 8px 32px rgba(232,160,32,0.35)", zIndex: 100 }}>
          ...
          <div style={{ fontSize: 16, fontWeight: 800, color: "#fff" }}>Checkout ?</div>
        </div>
      )}
    </div>
  );
  ...
  if (screen === "cart") return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: "#faf8f5", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: isMobile ? "20px 16px 100px" : "40px 40px 100px" }}>
        <button onClick={() => setScreen("home")} style={{ background: "none", border: "none", color: "#888", fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", marginBottom: 20, display: "flex", alignItems: "center", gap: 6 }}>? Back to menu</button>
        <div style={{ fontFamily: "'Playfair Display',serif", fontSize: isMobile ? 24 : 32, fontWeight: 900, color: "#1a0f02", marginBottom: 24 }}>Your Order \u{1F6D2}</div>
                ...
                <div key={id} style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 0", borderBottom: "1px solid #f5f2ee" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6 }}>
                    ...
                    <div style={{ display: "flex", gap: 6 }}>
                      <button onClick={() => rem(p.id)} style={{ background: "#fdf6ee", border: "1px solid #f0e8d8", color: "#E8A020", width: 28, height: 28, borderRadius: 8, fontSize: 16, fontWeight: 700, cursor: "pointer" }}>?</button>
              ...
              {ZONES.map(z => (
                <div key={z.name} onClick={() => setZone(z)} style={{ padding: 14, background: zone?.name === z.name ? "#fdf6ee" : "#faf8f5", border: `1.5px solid ${zone?.name === z.name ? "#E8A020" : "#f0ede8"}`, borderRadius: 12, cursor: "pointer", marginBottom: 10, transition: "all 0.15s" }}>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#1a0f02" }}>{z.name} ? R{z.fee}</div>
                      <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>{z.areas}</div>
                    </div>
                    {zone?.name === z.name && <span style={{ color: "#E8A020", fontSize: 18 }}>\u{2713}</span>}
                  </div>
                </div>
              ))}

              <input style={{ width: "100%", background: "#faf8f5", border: "1px solid #f0ede8", borderRadius: 10, padding: "12px 14px", fontSize: 14, outline: "none", fontFamily: "'DM Sans',sans-serif", color: "#333", marginTop: 8 }} placeholder="\u{1F4CD} Enter delivery address..." value={address} onChange={e => setAddress(e.target.value)} />
            </div>

            <div style={{ background: "#fff", borderRadius: 20, padding: 24, border: "1px solid #f0ede8", marginBottom: 16 }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#888", marginBottom: 14, textTransform: "uppercase", letterSpacing: "1px" }}>Payment</div>
              {[{ id: "snapscan", label: "SnapScan", icon: "\u{1F4F1}" }, { id: "payfast", label: "PayFast (Card)", icon: "\u{1F4B3}" }].map(m => (
                <div key={m.id} onClick={() => setPay(m.id)} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px", background: pay === m.id ? "#fdf6ee" : "#faf8f5", border: `1.5px solid ${pay === m.id ? "#E8A020" : "#f0ede8"}`, borderRadius: 12, cursor: "pointer", marginBottom: 10 }}>
                  ...
                  {pay === m.id && <span style={{ marginLeft: "auto", color: "#E8A020", fontWeight: 700 }}>\u{2713}</span>}
                </div>
              ))}
            </div>
    ...
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: "#faf8f5", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: isMobile ? "20px 16px 100px" : "40px 40px 100px" }}>
        <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
          {[["customer", "\u{1F464} Customer View"], ["driver", "\u{1F6F5} Driver View"]].map(([t, l]) => (
        ...
        {tab === "customer" && (
          <div style={{ background: "#fff", borderRadius: 24, padding: isMobile ? 20 : 32, border: "1px solid #f0ede8" }}>
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              <div style={{ fontSize: 64, animation: stage >= 2 ? "bounce 2s infinite" : "none", marginBottom: 14 }}>{stage === 4 ? "\u{1F389}" : stage >= 2 ? "\u{1F6F5}" : "\u{1F4E6}"}</div>
              <div style={{ fontFamily: "'Playfair Display',serif", fontSize: isMobile ? 22 : 28, fontWeight: 900, color: "#1a0f02" }}>{stage === 4 ? "Delivered! \u{1F37A}" : stage === 3 ? "Driver at your door!" : stage === 2 ? "On the way! \u{1F6F5}" : "Order Confirmed!"}</div>
              <div style={{ fontSize: 14, color: "#aaa", marginTop: 6 }}>Est. ~25 mins ? Lucky Star CBD</div>
            </div>
            {[{label:"Order received & paid",icon:"\u{2705}",s:1},{label:"Store packed ? photo taken \u{1F4F8}",icon:"\u{1F4E6}",s:1},{label:"Driver collected ? photo taken \u{1F4F8}",icon:"\u{1F6F5}",s:2},{label:"Driver at your door ? photo taken \u{1F4F8}",icon:"\u{1F4CD}",s:3},{label:"Confirmed by you \u{2705}",icon:"\u{1F389}",s:4}].map((step, i) => (
            ...
            {stage === 3 && !problem && (
              <>
                <button style={{ width: "100%", padding: 15, background: "linear-gradient(135deg,#22c55e,#16a34a)", border: "none", borderRadius: 14, color: "#fff", fontSize: 15, fontWeight: 800, cursor: "pointer", marginTop: 16, fontFamily: "'DM Sans',sans-serif" }} onClick={() => { setPickup(false); setDelivery(false); setStage(4); }}>\u{2705} Received & All Good ? Delete Photos</button>
                <button onClick={() => setProblem(true)} style={{ width: "100%", padding: 14, background: "transparent", border: "1.5px solid #ef4444", borderRadius: 14, color: "#ef4444", fontSize: 14, fontWeight: 700, cursor: "pointer", marginTop: 10, fontFamily: "'DM Sans',sans-serif" }}>\u{26A0}\u{FE0F} Report a Problem</button>
              </>
            )}
            {problem && <div style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 12, padding: 14, marginTop: 12 }}><div style={{ fontSize: 13, color: "#ef4444", fontWeight: 700 }}>\u{26A0}\u{FE0F} Photos kept. Management contacts you within 30 mins.</div></div>}
            {stage === 4 && (
              <>
                <div style={{ background: "#f0faf0", border: "1px solid #c6e8c6", borderRadius: 12, padding: 16, textAlign: "center", marginTop: 16 }}><div style={{ fontSize: 15, fontWeight: 700, color: "#22c55e" }}>\u{1F5D1}\u{FE0F} Photos Deleted ? Enjoy! \u{1F37A}</div></div>
                <button style={{ width: "100%", padding: 15, background: "linear-gradient(135deg,#E8A020,#C8601A)", border: "none", borderRadius: 14, color: "#fff", fontSize: 15, fontWeight: 800, cursor: "pointer", marginTop: 14, fontFamily: "'DM Sans',sans-serif" }} onClick={() => { setScreen("home"); setCart({}); setStage(0); setPickup(false); setDelivery(false); setProblem(false); setZone(null); }}>Order Again \u{1F37A}</button>
              </>
            )}
            {stage < 3 && (
              <div style={{ marginTop: 20, padding: 16, background: "#faf8f5", border: "1px solid #f0ede8", borderRadius: 14 }}>
                ...
                {stage === 1 && <button style={{ width: "100%", padding: 13, background: "#6366f1", border: "none", borderRadius: 12, color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }} onClick={() => { setPickup(true); setStage(2); }}>Simulate: Driver Collected \u{1F4F8}</button>}
                {stage === 2 && <button style={{ width: "100%", padding: 13, background: "#8b5cf6", border: "none", borderRadius: 12, color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }} onClick={() => { setDelivery(true); setStage(3); }}>Simulate: Driver Arrived \u{1F4F8}</button>}
              </div>
            )}
          </div>
        )}
        ...
        {tab === "driver" && (
          <div style={{ background: "#fff", borderRadius: 24, padding: isMobile ? 20 : 32, border: "1px solid #f0ede8" }}>
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 22, fontWeight: 900, color: "#1a0f02", marginBottom: 4 }}>Driver Dashboard \u{1F6F5}</div>
            ...
            <div style={{ background: "#fdf6ee", border: "1px solid #f0d8b0", borderRadius: 16, padding: 20, marginBottom: 20 }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#C8601A", marginBottom: 14 }}>\u{1F4E6} Active Order #UM2847</div>
              {[["\u{1F3EA} Pickup","Lucky Star Chinese Shop, CBD"],["\u{1F4CD} Deliver to","14 Sonheuwel Ave, Nelspruit"],["\u{1F5FA}\u{FE0F} Zone","Zone 1 ? ~3.2km ? Earn R35"]].map(([l,v]) => (
                <div key={l} style={{ fontSize: 14, color: "#666", marginBottom: 8 }}><span style={{ fontWeight: 600, color: "#888" }}>{l}:</span> {v}</div>
              ))}
              <div style={{ fontSize: 14, fontWeight: 700, color: "#1a0f02", margin: "16px 0 12px" }}>\u{1F4F8} Required Photos</div>
              {[{label:"Pickup Photo",sub:"Photo of packed order at store",done:pickup,action:()=>{setPickup(true);setStage(2);},canTap:!pickup},{label:"Delivery Photo",sub:pickup?"Photo at customer door":"Complete pickup first",done:delivery,action:()=>{setDelivery(true);setStage(3);},canTap:pickup&&!delivery}].map((ph,i)=>(
                <div key={i} onClick={ph.canTap?ph.action:undefined} style={{ background: ph.done?"#f0faf0":"#faf8f5", border:`2px dashed ${ph.done?"#86efac":"#e0dbd4"}`, borderRadius:14, padding:20, textAlign:"center", marginBottom:12, cursor:ph.canTap?"pointer":"default" }}>
                  {ph.done?<><div style={{fontSize:28,marginBottom:6}}>\u{2705}</div><div style={{fontSize:14,color:"#22c55e",fontWeight:700}}>{ph.label} Captured</div></>:<><div style={{fontSize:28,marginBottom:6}}>\u{1F4F7}</div><div style={{fontSize:14,color:ph.canTap?"#888":"#ccc",fontWeight:600}}>Tap ? {ph.label}</div><div style={{fontSize:12,color:"#ccc",marginTop:4}}>{ph.sub}</div></>}
                </div>
              ))}
              {stage===4&&<div style={{background:"#f0faf0",border:"1px solid #c6e8c6",borderRadius:10,padding:12}}><div style={{fontSize:13,color:"#22c55e",fontWeight:700}}>\u{2705} Confirmed! R35 added to your earnings.</div></div>}
            </div>
            <div style={{ background: "#faf8f5", borderRadius: 16, padding: 20, border: "1px solid #f0ede8" }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#888", marginBottom: 14 }}>\u{1F4B0} Tonight's Earnings</div>
